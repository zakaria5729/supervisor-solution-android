...
public class IntentAndBundleKey {
    public static final String KEY_TOPIC_AND_SUPERVISOR = "key topic supervisor intent";
    public static final String KEY_TOPIC_DATA = "key topic data";
    public static final String KEY_SUPERVISOR_DATA = "key supervisor data";
    ...
    public static final String KEY_FRAGMENT_AUTHENTICATION = "key fragment authentication";
    public static final String KEY_FRAGMENT_AUTHENTICATION_LOGIN = "key fragment authentication login";
    public static final String KEY_FRAGMENT_AUTHENTICATION_SIGN_UP = "key fragment authentication sign up";
